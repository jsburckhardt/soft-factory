...
| `initiatives/` | Initiative-scoped work following the Research → Architect → Plan → Implement pipeline |

## Conventions

- Every initiative follows the naming convention `INIT-####-short-slug`
